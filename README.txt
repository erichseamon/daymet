...
4.    From the command line run the following: java -Xms512m -Xmx1024m -jar daymet_multiple_extraction.jar latlon.txt OR Simply run daymet_multiple_extraction.sh
